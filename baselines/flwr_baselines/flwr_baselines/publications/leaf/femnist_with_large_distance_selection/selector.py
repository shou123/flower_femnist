...
class LargestDistanceActiveUserSelector:
    ...
    def get_user_indices(self, kwargs: Dict) -> List[int]:
        ...
        if len(client_local_model) == 0:
            ...
            with open("baselines/flwr_baselines/flwr_baselines/publications/leaf/femnist_with_large_distance_selection/plot/sorted_largest_client_distance.txt", 'a') as file:
        ...
        with open("baselines/flwr_baselines/flwr_baselines/publications/leaf/femnist_with_large_distance_selection/plot/selected_clients.txt", "w") as file:
