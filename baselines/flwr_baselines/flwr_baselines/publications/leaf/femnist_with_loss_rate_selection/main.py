...
from flwr_baselines.publications.leaf.femnist_with_loss_rate_selection.selector import LossRateActiveUserSelector
...
def main(cfg: DictConfig):
    ...
    client_selector = LossRateActiveUserSelector()
